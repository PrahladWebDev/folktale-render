    ...
    try {
      const response = await axios.post(
        'https://api.openai.com/v1/chat/completions',
        {
          ...
          messages: [
            {
              role: 'user',
              content: `Generate a ${form.genre} folktale from ${form.region} suitable for ${form.ageGroup}. The story should be engaging, culturally relevant, and appropriate for the selected age group. Provide a title prefixed with "Title:" followed by the story content. Ensure the title reflects the story's theme or main element.`,
            },
          ],
          max_tokens: 1000,
          temperature: 0.7,
        ...
        {
          headers: {
            'Authorization': `Bearer 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`,
      ...
      if (!title) {
        ...
        title = firstSentenceMatch
          ...
          : `A ${form.genre} Tale from ${form.region}`;
      }
