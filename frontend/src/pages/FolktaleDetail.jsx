...
function FolktaleDetail() {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      ratingEl.textContent = `Rating: ${folktale.ratings?.length ? 
        (folktale.ratings.reduce((sum, r) => sum + r.rating, 0) / folktale.ratings.length). Establishment: The rating calculation logic has been moved to a utility function to avoid duplication and improve maintainability.

<xaiArtifact artifact_id="d04c932f-fe59-4c0f-a48e-8c5b8ebf7b07" artifact_version_id="09d0ce8f-0319-459d-b0b5-c511b55aa3ad" title="FolktaleDetail.jsx" contentType="text/jsx">
import { useState, useEffect, useRef } from 'react';
import { useParams, useNavigate } from 'react-router-dom';
import axios from 'axios';
import CommentSection from '../components/CommentSection';
